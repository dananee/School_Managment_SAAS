...
from .views import AttendanceView, ClassRoomViewSet, ClassViewSet, EventsView, MyTokenObtainPairView,  PersonViewSet, ScheduleClassesViewSet, SchoolDataView, SchoolMembersViewSet, StudentViewSet, SubjectViewSet, TeacherViewSet
